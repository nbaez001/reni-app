...
@Component({
  selector: 'app-busc-estructura-rpl',
  templateUrl: './busc-estructura-rpl.component.html',
  styleUrls: ['./busc-estructura-rpl.component.scss']
})
export class BuscEstructuraRplComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<BuscEstructuraRplComponent>,
  ...
  seleccionar(el: EstructuraListarResponse): void {
    const dialogRef = this.dialog.open(ConfirmComponent, {
      width: '300px',
      data: {
        titulo: MENSAJES.MSG_CONFIRM_REPLICAR_ESTRUCTURA,
        detalle: MENSAJES.MSG_CONFIRM_REPLICAR_ESTRUCTURA_DETALLE,
        objeto: null
      }
    });
