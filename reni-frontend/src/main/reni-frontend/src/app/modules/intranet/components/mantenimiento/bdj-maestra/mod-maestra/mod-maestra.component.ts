...
import { MaestraModificarRequest } from 'src/app/modules/intranet/dto/request/maestra-modificar.request';
...
@Component({
  selector: 'app-mod-maestra',
  templateUrl: './mod-maestra.component.html',
  styleUrls: ['./mod-maestra.component.scss']
})
export class ModMaestraComponent implements OnInit {
  modif: boolean = false;
  ...
  constructor(private fb: FormBuilder,
    public dialogRef: MatDialogRef<ModMaestraComponent>,
  ...
  public inicializarVariables(): void {
    if (this.dataDialog.objeto) {
      ...
      this.formularioGrp.get('idTabla').setValue(this.dataDialog.objeto.idTabla);
    }
  }
  ...
  modMaestra(): void {
    if (this.formularioGrp.valid) {
      ...
      let req = new MaestraModificarRequest();
      req.idMaestra = this.dataDialog.objeto.idMaestra;
