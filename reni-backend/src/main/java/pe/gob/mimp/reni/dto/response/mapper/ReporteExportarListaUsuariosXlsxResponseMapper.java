...
public class ReporteExportarListaUsuariosXlsxResponseMapper implements RowMapper<Map<String, Object>> {

	List<ReporteIntervencionListaXlsxDetRequest> listaMapeo;
	List<ReporteIntervencionListarMaestraResponse> listaMaestra;

	public ReporteExportarListaUsuariosXlsxResponseMapper(List<ReporteIntervencionListaXlsxDetRequest> listaMapeo,
			List<ReporteIntervencionListarMaestraResponse> listaMaestra) {
	...
	public Map<String, Object> mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		for (ReporteIntervencionListaXlsxDetRequest ob : listaMapeo) {
